...
MainWindow::MainWindow()
{
    ...
    image = new QPixmap("C:/Users/UA Student/Documents/Senior design/SeniorDesignBAE-Saile/resources/Main.png");
...
void MainWindow::createActions()
{
    ...
    connect(startNew, SIGNAL (clicked()), this, SLOT (updateMessage()));
}
